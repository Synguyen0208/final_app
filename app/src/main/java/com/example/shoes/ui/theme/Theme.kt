...
private val LightColorPalette = ShoesColors(
    brand = Shadow5,
    mainPrice= FunctionalRed,
...
private val DarkColorPalette = ShoesColors(
    brand = Shadow1,
...
class ShoesColors(
    ...
    fun copy(): ShoesColors = ShoesColors(
...
fun ProvideShoesColors(
    ...
    CompositionLocalProvider(LocalShoesColors provides colorPalette, content = content)
}

private val LocalShoesColors = staticCompositionLocalOf<ShoesColors> {
    error("No ShoesColorPalette provided")
}
fun debugColors(
    darkTheme: Boolean,
